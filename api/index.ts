  ...
  if (method === 'PUT' && url === '/api/admin/site-content') {
    ...
    siteContent = {
      ...
      typography: {
        ...
        ...(incoming.typography || {}),
        heroSize: Math.min(160, Math.max(32, Number(incoming.typography?.heroSize ?? siteContent.typography.heroSize))),
        displaySize: Math.min(120, Math.max(24, Number(incoming.typography?.displaySize ?? siteContent.typography.displaySize))),
